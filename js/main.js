...
!(function (t) {
  ...
  t("#preloader").fadeOut("normall", function () {
    ...
    n.on("scroll", function () {
      ...
      a <= 175
        ? (t("header").removeClass("scrollHeader").addClass("fixedHeader"),
          e.attr("src", "img/logos/logo-inner.png"))
    ...
    t(".scroll-to-top").on("click", function (a) {
      a.preventDefault(), t("html, body").animate({ scrollTop: 0 }, 600);
    }),
    ...
    t(".vision-wrapper").on("mouseenter", function (a) {
      var e = t(this).data("background");
      t(".vision-changebg").animate({ opacity: 0.9 }, 50, function () {
        t(".vision-changebg").css("background-image", "url(" + e + ")");
      }),
    ...
    t(document).ready(function () {
      t(".testimonial-carousel3").owlCarousel({
        ...
        t(".slider-fade1").on("changed.owl.carousel", function (a) {
          a = a.item.index - 2;
        ...
        t(".countdown").countdown({
          date: "01 Sep 2026 00:01:00",
          format: "on",
        }),
        t(".current-year").text(new Date().getFullYear());
    }),
    n.on("load", function () {
      var e = t(".portfolio-gallery-isotope").isotope({});
