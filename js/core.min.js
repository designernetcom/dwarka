!(function (o) {
  ...
  (function (l, i, o, a) {
    ...
    (u.Defaults = {
      ...
      (u.prototype.closest = function (i, o) {
        var n = -1,
          s = this.width(),
          r = this.coordinates();
        return (
      ...
      (u.prototype.on = function (t, e, i, o) {
        t.addEventListener
          ? t.addEventListener(e, i, o)
          : t.attachEvent && t.attachEvent("on" + e, i);
      }),
      (u.prototype.off = function (t, e, i, o) {
        t.removeEventListener
          ? t.removeEventListener(e, i, o)
          : t.detachEvent && t.detachEvent("on" + e, i);
      }),
      (u.prototype.trigger = function (t, e, i, o, n) {
  ...
  (function (c, e) {
    ...
    (i.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
      ...
      (i.prototype.thumbnail = function (e, t) {
        ...
        if (
          (e.wrap(c("<div/>", { class: "owl-video-wrapper", style: s })),
  ...
  (function (n, s) {
    ...
    !(function () {
      ...
      ((n.support.transition = new String(u("transition"))),
      (n.support.transition.end = t.transition.end[n.support.transition])),
      o() &&
        ((n.support.animation = new String(u("animation"))),
        (n.support.animation.end = t.animation.end[n.support.animation])),
      e() &&
        ((n.support.transform = new String(u("transform"))),
    ...
    function (t, e, i) {
      ...
      (s.window.jarallax = r.default),
        (s.window.jarallax.noConflict = function () {
          return (s.window.jarallax = u), this;
        }),
        void 0 !== s.jQuery &&
          (((i = function () {
            var t = arguments || [];
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (
                    ...
                    u && i.css(i.image.$container, { opacity: 0.9999 }),
                  ...
                  : u.onAPIready(function () {
                      ...
                      u.$video ||
                          ...
                          (u.playerOptions.events = {
                            onReady: function (e) {
                              u.options.mute
                                ? e.target.mute()
                                : u.options.volume &&
                                  e.target.setVolume(u.options.volume),
                                u.options.autoplay &&
                        ...
                        "vimeo" === u.type &&
                          ...
                          u.$video ||
                            ((n = ""),
                            Object.keys(u.playerOptions).forEach(function (t) {
                              "" !== n && (n += "&"),
                                (n +=
                                  t +
                                  "=" +
                          ...
                          u.player.getVideoWidth().then(function (t) {
                            u.videoWidth = t || 1280;
                          }),
                          ...
                          (s = void 0),
                          u.player.on("timeupdate", function (t) {
                            s || (u.fire("started", t), (s = 1)),
                              u.fire("timeupdate", t),
                              u.options.endTime &&
                                u.options.endTime &&
                                t.seconds >= u.options.endTime &&
                                (u.options.loop
                                  ? u.play(u.options.startTime)
                                  : u.pause());
                          }),
                        ...
                        "local" === u.type &&
                          (u.$video ||
                            ...
                            a.appendChild(u.$video),
                            document.body.appendChild(a),
                            Object.keys(u.videoID).forEach(function (t) {
                              var e, i, o;
                              (e = u.$video),
                                (i = u.videoID[t]),
                                (o = "video/" + t),
                          ...
                          (r = void 0),
                          u.player.addEventListener("playing", function (t) {
                            r || u.fire("started", t), (r = 1);
                          }),
            ...
            },
            {
              ...
              value: function () {
                ...
                (l && u) ||
                  ...
                  "vimeo" !== this.type ||
                    u ||
                    ((u = 1), (t = "https://player.vimeo.com/api/player.js")),
                  t &&
    ...
    (u.prototype = {
      ...
      _repositionElements: function () {
        ...
        if (
          ...
          for (u = this.backgrounds.length - 1; 0 <= u; u--)
            (e = (i = this.backgrounds[u]).isFixed ? 0 : 1),
        ...
        return e === m || "object" == typeof e
          ? this.each(function () {
              f.data(this, "plugin_" + o) ||
                f.data(this, "plugin_" + o, new u(this, e));
            })
      ...
      (i.prototype.handleScroll = function () {
        ...
        for (t in o) {
          ...
          for (n in this.waypoints[t]) {
            var a,
              l,
              u = this.waypoints[t][n];
            null !== u.triggerPoint &&
              ((a = s.oldScroll < u.triggerPoint),
              (l = s.newScroll >= u.triggerPoint),
              ((a && l) || (!a && !l)) &&
                (u.queueTrigger(r), (i[u.group.id] = u.group)));
          }
        }
        ...
        (t = {
          ...
          for (s in this.waypoints[e]) {
            ...
            l.element !== l.element.window &&
              ...
              (l.triggerPoint = Math.floor(d + a - u)),
              (a = c < r.oldScroll),
              (u = l.triggerPoint >= r.oldScroll),
              (c = !a && !u),
              !h && a && u
                ? (l.queueTrigger(r.backward), (n[l.group.id] = l.group))
                : ((!h && c) || (h && r.oldScroll >= l.triggerPoint)) &&
  ...
  (function (t) {
    ...
    function d(t, e, i, o) {
      ...
      return (
        (n.className = "mfp-" + t),
        i && (n.innerHTML = i),
        o ? e && e.appendChild(n) : ((n = u(n)), e && n.appendTo(e)),
        n
      );
    }
    function h(t, e) {
      f.ev.triggerHandler("mfp" + t, e),
        f.st.callbacks &&
          ...
          f.st.callbacks[t] &&
            f.st.callbacks[t].apply(f, u.isArray(e) ? e : [e]));
    }
    function p(t) {
      return (
    ...
    function s() {
      u.magnificPopup.instance ||
        ((f = new t()).init(), (u.magnificPopup.instance = f));
    }
    var f,
      o,
      m,
    ...
    (t.prototype = {
      ...
      _openClick: function (t, e, i) {
        if (
          (void 0 !== i.midClick ? i : u.magnificPopup.defaults).midClick ||
          !(2 === t.which || t.ctrlKey || t.metaKey || t.altKey || t.shiftKey)
        ) {
          var o = (void 0 !== i.disableOn ? i : u.magnificPopup.defaults)
            .disableOn;
          if (o)
            if (u.isFunction(o)) {
      ...
      _onFocusIn: function (t) {
        return t.target === f.wrap[0] || u.contains(f.wrap[0], t.target)
          ? void 0
          : (f._setFocus(), !1);
      },
          ...
          if ((C(), t.src)) {
            ...
            return (
              n.length
                ...
                : (f.updateStatus("error", o.tNotFound), (n = u("<div>"))),
              (t.inlineElement = n)
            );
          }
    ...
    u.magnificPopup.registerModule(A, {
      ...
      proto: {
        ...
        getAjax: function (o) {
          I && u(document.body).addClass(I), f.updateStatus("loading");
          var t = u.extend(
            {
              url: o.src,
        ...
        getImage: function (t, e) {
          ...
          return (
            a.length &&
              ...
              (t.img = u(i).on("load.mfploader", n).on("error.mfploader", s)),
              (i.src = t.src),
      ...
      (e.prototype.init = function () {
        ...
        (e.prototype.loadContent = function (e, t, i) {
          var o,
            ...
            h = u.s.dynamic
              ? (u.s.dynamicEl[e].poster &&
                  ((c = !0), (n = u.s.dynamicEl[e].poster)),
                (r = u.s.dynamicEl[e].html),
                (a = u.s.dynamicEl[e].src),
                (l = u.s.dynamicEl[e].alt),
                u.s.dynamicEl[e].responsive &&
                  d(u.s.dynamicEl[e].responsive.split(",")),
                (s = u.s.dynamicEl[e].srcset),
                u.s.dynamicEl[e].sizes)
              : ((p = u.$items.eq(e)).attr("data-poster") &&
            ...
            d = !1;
          u.s.dynamic
            ? u.s.dynamicEl[e].iframe && (d = !0)
            : "true" === u.$items.eq(e).attr("data-iframe") && (d = !0);
          var p = u.isVideo(a, e);
          if (!u.$slide.eq(e).hasClass("lg-loaded")) {
            if (
              (d
                ...
                ? (u.$slide
                  ...
                  u.$el.trigger("hasVideo.lg", [e, a, r]))
                : ((l = l ? 'alt="' + l + '"' : ""),
                  u.$slide
                    .eq(e)
                    .prepend(
              ...
              u.$el.trigger("onAferAppendSlide.lg", [e]),
              (o = u.$slide.eq(e).find(".lg-object")),
              h && o.attr("sizes", h),
            ...
            ".lg-sub-html" !== this.s.appendSubHtmlTo && u.addHtml(e),
              u.$slide.eq(e).addClass("lg-loaded");
          }
          u.$slide
            .eq(e)
            .find(".lg-object")
            .on("load.lg error.lg", function () {
              ...
              i && !f("body").hasClass("lg-from-hash") && (t = i),
                setTimeout(function () {
                  u.$slide.eq(e).addClass("lg-complete"),
                    u.$el.trigger("onSlideItemLoad.lg", [e, i || 0]);
                }, t);
            }),
            p && p.html5 && !c && u.$slide.eq(e).addClass("lg-complete"),
            !0 === t &&
        ...
        (e.prototype.slide = function (t, e, i, o) {
          var n,
            ...
            a,
            l,
            u = this.$outer.find(".lg-current").index(),
            c = this;
          (c.lGalleryOn && u === t) ||
            ((n = this.$slide.length),
            (s = c.lGalleryOn ? this.s.speed : 0),
            c.lgBusy ||
              (this.s.download &&
                ((r = c.s.dynamic
                  ? !1 !== c.s.dynamicEl[t].downloadUrl &&
                    (c.s.dynamicEl[t].downloadUrl || c.s.dynamicEl[t].src)
                  : "false" !== c.$items.eq(t).attr("data-download-url") &&
                    (c.$items.eq(t).attr("data-download-url") ||
              ...
              this.$el.trigger("onBeforeSlide.lg", [u, t, e, i]),
              (c.lgBusy = !0),
              ...
              c.lGalleryOn
                ? (setTimeout(function () {
                  ...
                  setTimeout(function () {
                    (c.lgBusy = !1),
                      c.$el.trigger("onAfterSlide.lg", [u, t, e, i]);
                  }, this.s.speed))
    ...
    !(function () {
      ...
      function t(t) {
        return (
          ...
          (this.$el = u(t)),
          (this.core.s = u.extend({}, e, this.core.s)),
          (this.videoLoaded = !1),
          this.init(),
          this
        );
          ...
          o.core.$el.on(
            ...
            function (t, e, i) {
              ...
              e &&
                u(e).attr(
                  "src",
                  u(e).attr("src").replace("&autoplay", "&noplay")
                );
              e = o.core.s.dynamic
            ...
            o.youtube
              ? ((l = "?wmode=opaque&autoplay=" + a + "&enablejsapi=1"),
                this.core.s.youtubePlayerParams &&
                  (l = l + "&" + u.param(this.core.s.youtubePlayerParams)),
                (r =
              ...
              ? ((l = "?autoplay=" + a + "&api=1"),
                this.core.s.vimeoPlayerParams &&
                  (l = l + "&" + u.param(this.core.s.vimeoPlayerParams)),
                (r =
              ...
              : o.vk &&
                ...
                this.core.s.vkPlayerParams &&
                  (l = l + "&" + u.param(this.core.s.vkPlayerParams)),
                (r =
      ...
      (t.prototype.init = function () {
        ...
        (t.prototype.zoomSwipe = function () {
          ...
          n.core.$slide.on("touchstart.lg", function (t) {
            ...
            n.core.$outer.hasClass("lg-zoomed") &&
              ...
              (c = n.getCurrentRotation(o)),
              (e = n.getDragAllowedAxises(e, Math.abs(c))),
              (u = e.allowY),
              ((l = e.allowX) || u) &&
                (t.preventDefault(), (s = n.getSwipeCords(t, Math.abs(c)))));
          }),
            n.core.$slide.on("touchmove.lg", function (t) {
              ...
              n.core.$outer.hasClass("lg-zoomed") &&
                ...
                t.preventDefault(),
                (a = !0),
                (r = n.getSwipeCords(t, Math.abs(c))),
                n.core.$outer.addClass("lg-zoom-dragging"),
                (i = u
                  ? -Math.abs(e.attr("data-y")) +
                    (r.y - s.y) * n.getModifier(c, "Y", o)
                  : -Math.abs(e.attr("data-y"))),
                (t = l
                  ? -Math.abs(e.attr("data-x")) +
                    (r.x - s.x) * n.getModifier(c, "X", o)
                  : -Math.abs(e.attr("data-x"))),
        ...
        (t.prototype.touchendZoom = function (t, e, i, o, n) {
          ...
          (15 < Math.abs(e.x - t.x) || 15 < Math.abs(e.y - t.y)) &&
            ...
            i && (u <= -n.maxX ? (u = -n.maxX) : u >= -n.minX && (u = -n.minX)),
            o
              ? r.attr("data-y", Math.abs(l))
              : (l = -Math.abs(r.attr("data-y"))),
            i
              ? r.attr("data-x", Math.abs(u))
              : (u = -Math.abs(r.attr("data-x"))),
            s.core.s.useLeftForZoom
              ? r.css({ left: u + "px", top: l + "px" })
              : r.css("transform", "translate3d(" + u + "px, " + l + "px, 0)"));
        }),
        (t.prototype.destroy = function () {
          var t = this;
      ...
      (h.dispatchEvent = function (t, e, i) {
        ...
        this.emitEvent(t, o),
          u &&
            ...
            e
              ? (((e = u.Event(e)).type = t), this.$element.trigger(e, i))
    ...
    var u = /\blang(?:uage)?-([\w-]+)\b/i,
      ...
      z = {
        ...
        highlightElement: function (t, e, i) {
          for (var o, n = "none", s = t; s && !u.test(s.className); )
            s = s.parentNode;
          s &&
            ((n = (s.className.match(u) || [, "none"])[1].toLowerCase()),
            (o = z.languages[n])),
            (t.className =
              t.className.replace(u, "").replace(/\s+/g, " ") +
              " language-" +
              n),
            t.parentNode &&
              ((s = t.parentNode),
        ...
        matchGrammar: function (t, e, i, o, n, s, r) {
          for (var a in i)
            if (i.hasOwnProperty(a) && i[a]) {
              if (a == r) return;
              for (
                var l = i[a], l = "Array" === z.util.type(l) ? l : [l], u = 0;
                u < l.length;
                ++u
              ) {
                var c,
                  ...
                  if (!(b instanceof I)) {
                    ...
                    if (S) {
                      ...
                      var E = b.slice(0, w),
                        k = b.slice(x),
                        b = [y, T];
                      E && (++y, (v += E.length), b.push(E));
                      E = new I(a, h ? z.tokenize(S, h) : S, g, S, f);
                      if (
                        (b.push(E),
                        k && b.push(k),
